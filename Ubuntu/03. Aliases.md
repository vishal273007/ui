...
nohup sleep infinity &>/dev/null &; disown # Keep ubuntu running in background

function run; javac $argv[1] && java (basename $argv[1] .java); end # function to run java program

...
### Ubuntu packages:
- `sudo apt install git python openjdk-21 nodejs ssh sshpass adb fastboot plateform-tools neovim build-essential wget curl gcc libfuse2 make net-tools ripgrep unzip`
